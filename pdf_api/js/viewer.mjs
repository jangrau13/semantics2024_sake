...
/* harmony export */   handleUpdatePDFAfterKGAdd: () => (/* binding */ handleUpdatePDFAfterKGAdd)
/* harmony export */ });
...
/* harmony import */ var _modals_workerHandler_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9399);
...
class Modal {
  constructor() {
    ...
    this.initStore().then(success => {
      ...
      _WiserEventBus_js__WEBPACK_IMPORTED_MODULE_4__["default"].on('downloadKnowledge', () => {
    ...
    window.myAtomicWorker.onmessage = async e => {
      switch (e.data.type) {
        case "pong":
          ...
          break;
        case "conceptButtons":
          await (0,_modals_workerHandler_js__WEBPACK_IMPORTED_MODULE_5__.handleConceptButtons)(e.data);
          break;
        case 'updatePDFAfterKGAdd':
          await (0,_modals_workerHandler_js__WEBPACK_IMPORTED_MODULE_5__.handleUpdatePDFAfterKGAdd)(e.data, document);
          break;
        case 'ping':
          break;
        default:
